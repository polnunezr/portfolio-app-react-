...
const Work = () => {
  return (
    <div name="work" className="w-full md:h-screen text-[#f0f8ff] bg-[#806586]">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="pb-8">
          <p className="text-4xl font-bold inline border-b-4 text-[#f0f8ff] border-[#e3b8c6]">
            Work
          </p>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://youtu.be/gzXPV1A-e_U">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/polnunezr/pokemon">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
                </a>
          ...
          <div
            style={{ backgroundImage: `url(${resenas})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
